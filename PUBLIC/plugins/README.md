...
|--------|--------|------|------|-------|----------|
| [UAM (Марбэйс id)](./uam/) | 2.1.0 | `uam` | 8060 | `auth.markbase.ru` | Единая аутентификация, SSO, сессии, проверка email, многоуровневая защита |
...
## Авторизация через Марбэйс id

Для подключения кнопки **«Войти через Марбэйс id»** — см. [auth-widget/](../auth-widget/).

---

## Принципы

1. **Единый вход** — все модули используют UAM (Марбэйс id) для аутентификации
