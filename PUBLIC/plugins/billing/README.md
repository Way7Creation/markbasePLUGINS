...
Модуль Billing использует **кэш сессий UAM** для обеспечения бесперебойной работы:
...
> Залогиненные пользователи **не вылетят** из Billing при кратковременных проблемах auth.markbase.ru.
