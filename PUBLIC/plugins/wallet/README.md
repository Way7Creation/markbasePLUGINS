...
Модуль Wallet использует **кэш сессий UAM** для обеспечения бесперебойной работы:
...
> Залогиненные пользователи **не вылетят** из Wallet при кратковременных проблемах auth.markbase.ru.
