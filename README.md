...
|-----------|------------|
| [`PUBLIC/README.md`](./PUBLIC/README.md) | Обзор для разработчиков: Маркбэйс id, принципы, безопасность, быстрый старт |
...
| [`PUBLIC/auth-widget/`](./PUBLIC/auth-widget/) | Кнопка «Войти через Маркбэйс id» (OAuth 2.0 + PKCE) |
...
1. **Единый вход** — все модули используют UAM (Маркбэйс id).
