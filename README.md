...
|-----------|------------|
| [`PUBLIC/README.md`](./PUBLIC/README.md) | Обзор для разработчиков: WaySenID, принципы, безопасность, быстрый старт |
...
| [`PUBLIC/auth-widget/`](./PUBLIC/auth-widget/) | Кнопка «Войти через WaySenID» (OAuth 2.0 + PKCE) |
...
1. **Единый вход** — все модули используют UAM (WaySenID).
